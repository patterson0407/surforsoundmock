...
interface EnhancedGooglePlacesWidgetProps {
...
export function EnhancedGooglePlacesWidget({
  type,
  title,
  description,
  maxResults = 12,
...
}: EnhancedGooglePlacesWidgetProps) {
  ...
  useEffect(() => {
    ...
    fetchPlaces()
  }, [type, userLocation.lat, userLocation.lng])
  ...
  useEffect(() => {
    ...
    setFilteredPlaces(filtered.slice(0, maxResults))
  }, [places, searchTerm, ratingFilter, priceFilter, typeFilter, sortBy, maxResults])
